...
while(true){
if((i__4737__auto___29570 < len__4736__auto___29568)){
args__4742__auto__.push((arguments[i__4737__auto___29570]));

var G__29572 = (i__4737__auto___29570 + (1));
i__4737__auto___29570 = G__29572;
continue;
} else {
}
break;
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29429,G__29430,seq29428__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__29442_SHARP_){
return (!((cljs.core.meta(p1__29442_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29484__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e29501){var _e__27221__auto__ = e29501;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e29505){var _e__27221__auto__ = e29505;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__29509 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__29510 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__29510);

try{var map__29511 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29511__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__29509);
}});
...
var temp__5733__auto___29696 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___29696)){
var managed_print_level_29698 = temp__5733__auto___29696;
var _STAR_print_level_STAR__orig_val__29540_29699 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29541_29700 = managed_print_level_29698;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29541_29700);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__29513_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__29513_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29540_29699);
}} else {
job_fn();
}
