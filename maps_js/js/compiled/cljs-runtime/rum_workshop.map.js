...
return module$node_modules$esri_leaflet$dist$esri_leaflet_debug.basemapLayer("Gray").addTo(module$node_modules$leaflet$dist$leaflet_src.map("mapid",({"preferCanvas": true, "keyboard": false})).setView(cljs.core.clj__GT_js(cljs.core.deref(rum_workshop.map.position)),(13)));
...
console.log(navigator.geolocation.getCurrentPosition((function (p1__27895_SHARP_){
return cljs.core.reset_BANG_(rum_workshop.map.position,p1__27895_SHARP_);
}),console.log));

return console.log(document.querySelector("div#mapid",cljs.core.clj__GT_js(cljs.core.deref(rum_workshop.map.position))));
});
