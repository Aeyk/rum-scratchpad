...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30601 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30601(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30603 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30603(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30605 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30605(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30606 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30606(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30608 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30608(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30610 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30610(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_30611 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_30611(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_30613 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_30613(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_30616 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_30616(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_30617 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_30617(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_30618 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_30618(b);
}
});
