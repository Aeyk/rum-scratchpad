...
var vec__36619 = cljs.core.name(k).split("-");
var seq__36620 = cljs.core.seq(vec__36619);
var first__36621 = cljs.core.first(seq__36620);
var seq__36620__$1 = cljs.core.next(seq__36620);
var first_word = first__36621;
var words = seq__36620__$1;
...
var m__$1 = cljs.core.persistent_BANG_(cljs.core.reduce_kv((function (p1__36631_SHARP_,p2__36632_SHARP_,p3__36633_SHARP_){
return cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(p1__36631_SHARP_,daiquiri.util.camel_case(p2__36632_SHARP_),p3__36633_SHARP_);
}),cljs.core.transient$(cljs.core.PersistentArrayMap.EMPTY),m));
var G__36635 = m__$1;
if(cljs.core.map_QMARK_(new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m__$1))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__36635,new cljs.core.Keyword(null,"style","style",-496642736),daiquiri.util.camel_case_keys);
} else {
return G__36635;
}
} else {
