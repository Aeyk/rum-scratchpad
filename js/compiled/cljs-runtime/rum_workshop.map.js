...
console.log(navigator.geolocation.getCurrentPosition((function (p1__27612_SHARP_){
return cljs.core.reset_BANG_(rum_workshop.map.location,p1__27612_SHARP_.coords);
}),console.log));

if(cljs.core.not(navigator.geolocation)){
navigator.geolocation.getCurrentPosition((function (p1__27613_SHARP_){
return cljs.core.reset_BANG_(rum_workshop.map.location,p1__27613_SHARP_);
}),console.log);
} else {
}
