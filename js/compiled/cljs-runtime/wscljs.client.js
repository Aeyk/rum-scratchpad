...
var expr__29610 = socket.readyState;
if(cljs.core.truth_((pred__29609.cljs$core$IFn$_invoke$arity$2 ? pred__29609.cljs$core$IFn$_invoke$arity$2((0),expr__29610) : pred__29609.call(null,(0),expr__29610)))){
return new cljs.core.Keyword(null,"connecting","connecting",-1347943866);
} else {
if(cljs.core.truth_((pred__29609.cljs$core$IFn$_invoke$arity$2 ? pred__29609.cljs$core$IFn$_invoke$arity$2((1),expr__29610) : pred__29609.call(null,(1),expr__29610)))){
return new cljs.core.Keyword(null,"open","open",-1763596448);
} else {
if(cljs.core.truth_((pred__29609.cljs$core$IFn$_invoke$arity$2 ? pred__29609.cljs$core$IFn$_invoke$arity$2((2),expr__29610) : pred__29609.call(null,(2),expr__29610)))){
return new cljs.core.Keyword(null,"stopping","stopping",1036724975);
} else {
if(cljs.core.truth_((pred__29609.cljs$core$IFn$_invoke$arity$2 ? pred__29609.cljs$core$IFn$_invoke$arity$2((3),expr__29610) : pred__29609.call(null,(3),expr__29610)))){
return new cljs.core.Keyword(null,"stopped","stopped",-1490414640);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__29610)].join('')));
}
}
}
}
 ...
 *   
 */
wscljs.client.create = (function wscljs$client$create(url,p__29612){
...
var handler_map = map__29613__$1;
var on_open = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29613__$1,new cljs.core.Keyword(null,"on-open","on-open",-1391088163));
var on_message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29613__$1,new cljs.core.Keyword(null,"on-message","on-message",1662987808));
var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29613__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var on_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29613__$1,new cljs.core.Keyword(null,"on-error","on-error",1728533530));
