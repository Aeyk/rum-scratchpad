...
var G__29223 = devtools.prefs.pref(v);
v = G__29223;
continue;
} else {
return v;
...
}catch (e29166){var _e__27221__auto__ = e29166;
return false;
}})();
...
}catch (e29191){var _e__27221__auto__ = e29191;
return false;
}})();
...
}catch (e29193){var _e__27221__auto__ = e29193;
return false;
}}
}
});
...
var vec__29201 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29201,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29201,(1),null);
...
return cljs.core.some((function (p1__29204_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__29204_SHARP_);
}),template);
});
