...
var sablono$interpreter$IInterpreter$interpret$dyn_36732 = (function (this$){
...
return sablono$interpreter$IInterpreter$interpret$dyn_36732(this$);
}
});
...
var x36684_36735 = ctor.prototype;
(x36684_36735.onChange = (function (event){
var this$ = this;
...
(x36684_36735.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
switch (G__36689) {
case "input":
var G__36690 = ((cljs.core.object_QMARK_(props))?props.type:false);
switch (G__36690) {
case "radio":
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq36691){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36692,G__36693,seq36691__$2);
}));
...
var vec__36695 = sablono.normalize.element(element);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36695,(0),null);
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36695,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36695,(2),null);
